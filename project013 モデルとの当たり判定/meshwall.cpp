...
{
	"data\\TEXTURE\\wall000.jpg",		// メッシュウォールのテクスチャの相対パス
};
...
void InitMeshWall(void)
{
	...
	// メッシュウォールの設定
	SetMeshWall(D3DXVECTOR3(0.0f, 0.0f, 1200.0f),  D3DXVECTOR3(0.0f, D3DXToRadian(0),   0.0f), 2400.0f, 200.0f, 14, 1);
	SetMeshWall(D3DXVECTOR3(1200.0f, 0.0f, 0.0f),  D3DXVECTOR3(0.0f, D3DXToRadian(90),  0.0f), 2400.0f, 200.0f, 14, 1);
	SetMeshWall(D3DXVECTOR3(0.0f, 0.0f, -1200.0f), D3DXVECTOR3(0.0f, D3DXToRadian(180), 0.0f), 2400.0f, 200.0f, 14, 1);
	SetMeshWall(D3DXVECTOR3(-1200.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, D3DXToRadian(270), 0.0f), 2400.0f, 200.0f, 14, 1);
		...
		{ // メッシュウォールが使用されている場合
			...
			{ // 縦の分割数 +1回繰り返す
				...
				{ // 横の分割数 +1回繰り返す
					...
					//( // 引数
					//	nCntWidth * (1.0f / (float)g_aMeshWall[nCntMeshWall].nPartWidth) - (1.0f * 0.5f),	// u
					//	nCntHeight * (1.0f / (float)g_aMeshWall[nCntMeshWall].nPartHeight) - (1.0f * 0.5f)	// v
					//);
