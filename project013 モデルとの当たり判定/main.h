...
#define STAGE_LIMIT_NEAR	(1200.0f)		// 移動制限の位置 (手前)
#define STAGE_LIMIT_FAR		(-1200.0f)		// 移動制限の位置 (奥)
#define STAGE_LIMIT_RIGHT	(1200.0f)		// 移動制限の位置 (右)
#define STAGE_LIMIT_LEFT	(-1200.0f)		// 移動制限の位置 (左)
